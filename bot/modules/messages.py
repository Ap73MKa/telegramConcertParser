...
class Messages(ABC):
    ...
    def get_site_info() -> str:
        return (
            '<b><a href="https://kassir.ru">Kassir</a></b> - сайт, на котором мы и узнаем все информацию об '
    ...
    def get_bot_info() -> str:
        ...
        return (
            f"<b>tgConcerts</b> - это особый телеграм бот, который собирает информацию о всех концертах городов "
    ...
    def get_concert_list(city_abb: str) -> str:
        ...
        return (
            f'<a href="https://{city_abb}.{Config.KASSIR_SITE}">{get_city_by_abb(city_abb).name.upper()}</a>. '
            f"Список концертов\n\n\n{concert_list}"
        )
